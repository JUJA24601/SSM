subroutine calc_matrix(rectangles_data, num_of_rectangles, P)
    ...
    double precision rectangles_data(num_of_rectangles,4,3), P(num_of_rectangles,num_of_rectangles), eps0, pi, coord(4,3), side(3),&
    ...
    do i = 1, num_of_rectangles
        ...
        a = MAXVAL(side)
        p0 = rectangles_data(i, MAXLOC(side),:)
